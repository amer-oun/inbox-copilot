...
import { isDemoSampleModel, type ThreadSummaryDto } from "@inbox-copilot/shared";
  ...
  return (
    ...
    >
      ...
      <p className="border-t border-accent-line px-4 py-2 text-xs leading-relaxed text-muted">
        {/*
          Demo summaries were written by hand, so they cannot name a model. They say so
          rather than borrow one: "names the model that wrote it" is a promise.
        */}
        {isDemoSampleModel(summary.model)
          ? "Written in advance for the demo, in the shape a live summary takes. A live summary names the model that wrote it."
          : `Generated by ${summary.model} from the messages below. It can be wrong, and it describes what the senders wrote — not advice.`}
      </p>
    </section>
  );
}
